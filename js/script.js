...
var countDownDate = new Date("Nov 30, 2024 07:00:00").getTime();
...
function noSasha() {
  var teks = document.getElementById("textSalin1").textContent;
  ...
  toastr["success"]("Alamat Berhasil Disalin", "Success");
}
function noDeki() {
